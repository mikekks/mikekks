...
* 문과에서 전과 후, 차석 졸업까지 빠른 성장 속도를 바탕으로 이룰 수 있었습니다.
* 사용자 중심 엔지니어링 관점으로 현실 문제를 해결하고자 합니다.
* 문제의 원인을 파악할 때, 그 원인이 발생한 상황이나 환경에도 주의를 기울입니다. 이를 통해 문제가 발생하기 어려운 환경을 만들고자 합니다.
* 깊게 고민하는 것을 좋아합니다. 고민의 흔적들이 휘발되지 않도록 아카이빙하고 있습니다. ([블로그](https://gamxong.tistory.com))
